...
img_path = 'C:\\Users\\annly\\OneDrive\\Desktop\\reactfinal\\server\\venv\\images\\one.jpg'
#model_path = 'E:\\GitHub\\count_people\\server\\venv\\weights\\yolov8n-face.onnx'
model_path = 'C:\\Users\\annly\\OneDrive\\Desktop\\reactfinal\\server\\venv\\weights\\yolov8n-face.onnx'


confThreshold = 0.0131
nmsThreshold = 0.308


YOLOv8_face_detector = YOLOv8_face(
model_path, conf_thres=confThreshold, iou_thres=nmsThreshold)
...
def upload():
    ...
    if image_data:
        # Process the image here (e.g., save to disk, analyze, etc.)
        # ...
        print("yessss")
